    ...
    <Card>
      <CardHeader>
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-base">
          <h3
            className="font-semibold leading-none text-start"
            id={`education-${school.toLowerCase().replace(/\s+/g, '-')}`}
          >
            {school}
          </h3>
          <div
            className="text-sm tabular-nums text-gray-500 text-start sm:text-end"
      ...
      <CardContent
        className="mt-2 text-start text-design-resume print:text-[12px]"
