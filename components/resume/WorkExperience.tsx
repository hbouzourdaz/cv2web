            ...
            >
              <div className="flex flex-wrap justify-between items-start self-stretch gap-2">
                <div className="flex flex-wrap justify-start items-center gap-2">
                  <p className="text-base font-semibold text-start text-[#050914]">
                    {item.title}
                  </p>
                ...
                <p className="text-sm text-end text-[#54575e]">
                  {item.formattedDate}
                </p>
              </div>
              <div className="flex flex-col justify-start items-start relative gap-1.5 w-full">
                <p className="self-stretch text-sm font-medium text-start text-[#54575e] font-mono capitalize flex flex-wrap gap-1">
                  <span>{item.companyLower}</span>
                  {item.company && item.contract && <span>·</span>}
                  <span>{item.contract}</span>
                </p>
                <p className="self-stretch text-sm font-medium text-start text-[#6c737f] whitespace-pre-line">
                  {item.description}
                </p>
              </div>
            </div>
