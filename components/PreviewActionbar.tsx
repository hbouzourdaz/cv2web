...
export default function PreviewActionbar({
  ...
  return (
    <>
      <div className="w-full rounded-lg bg-[#fcfcfc] border-[0.5px] border-neutral-300 flex items-center justify-between py-3 px-4 sm:px-5 sm:py-2.5 flex-col sm:flex-row gap-4">
        <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 w-full">
          ...
          <div className="overflow-hidden rounded bg-white border-[0.5px] border-neutral-300 flex flex-row w-full max-w-[180px] sm:max-w-none sm:w-auto md:w-80">
            <span className="flex-1 p-2.5 sm:p-3 text-sm text-[#5d5d5d] border-none outline-none focus:ring-0 bg-transparent w-fit truncate">
              {initialUsername}
            </span>
            ...
            <Button
              variant="ghost"
              size="icon"
              className="size-[38px] sm:size-[44px] flex items-center justify-center border-l-[0.5px] flex-shrink-0"
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-1">
              {status === 'live' ? (
                <button
                  onClick={() =>
                    window.open(getUrl(initialUsername), '_blank')
                  }
            ...
            <Button
              ...
              className={`flex items-center min-w-[80px] sm:min-w-[100px] min-h-8 gap-1.5 px-2 sm:px-3 py-1.5 h-auto text-xs sm:text-sm ${
                status === 'draft'
            ...
            {status === 'live' && (
              <Button className="flex items-center min-w-[80px] sm:min-w-[100px] min-h-8 gap-1.5 px-2 sm:px-3 py-1.5 h-auto text-xs sm:text-sm">
                <a
